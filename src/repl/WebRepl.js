...
export class WebRepl {
    ...
    _setupEventListeners() {
        const eventHandlers = {
            ...
            'narsese.processed': (data) => this._broadcastToAllClients({
                type: MESSAGE_TYPES.NARSESE_PROCESSED,
                payload: data
            }),
            ...
            'nar.cycle.step': (data) => this._broadcastToAllClients({
                type: MESSAGE_TYPES.NAR_CYCLE_STEP,
                payload: data
            }),
            'nar.cycle.running': (data) => this._broadcastToAllClients({
                type: MESSAGE_TYPES.NAR_CYCLE_RUNNING,
                payload: data
            }),
            ...
            'nar.trace.enable': (data) => this._broadcastToAllClients({
                type: MESSAGE_TYPES.NAR_TRACE_ENABLE,
                payload: data
            }),
            'nar.trace.restore': (data) => this._broadcastToAllClients({
                type: MESSAGE_TYPES.NAR_TRACE_RESTORE,
                payload: data
            }),
