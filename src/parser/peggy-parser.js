...
function peg$parse(input, options) {
  ...
  const peg$e5 = peg$otherExpectation("quoted term");
  ...
  const peg$e35 = peg$otherExpectation("atomic term");
  const peg$e36 = peg$classExpectation(["(", ")", "{", "}", "<", ">", ".", ",", "!", "%", "?", ";", " ", "\t", "\n", "\r", "=", "&", "/", "|", ">", "-"], true, false, false);
  const peg$e37 = peg$otherExpectation("variable");
  ...
  function peg$f5() {    return options.termFactory.atomic(text());  }
  function peg$f6(op, components) {
    return options.termFactory.create(op, components);
  }
  function peg$f7(operator, components) {
    return options.termFactory.create(operator.name, components || []);
  }
  function peg$f8(components) {
  ...
  function peg$f10(subject, op, predicate) {
    return options.termFactory.create(op.trim(), [subject, predicate]);
  }
  function peg$f11(op) {    return op.endsWith(',') ? op.slice(0, -1) : op;  }
  function peg$f12(op) {    return op;  }
  function peg$f13(components) {    return options.termFactory.setExt(components || []);  }
  function peg$f14(components) {    return options.termFactory.setInt(components || []);  }
