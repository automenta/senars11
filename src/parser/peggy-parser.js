...
function peg$parse(input, options) {
  ...
  const peg$e29 = peg$otherExpectation("atomic term");
  const peg$e30 = peg$classExpectation(["(", ")", "{", "}", "<", ">", ".", ",", "!", "%", "?", ";", " ", "\t", "\n", "\r", "-"], true, false, false);
  const peg$e31 = peg$otherExpectation("variable");
  const peg$e32 = peg$classExpectation(["?", "$", "#", "*"], false, false, false);
  const peg$e33 = peg$otherExpectation("float");
  ...
  function peg$f14(components) {    return options.termFactory.create({ operator: '[]', components: components || [] });  }
  ...
  function peg$f16(chars) {    return options.termFactory.create(chars);  }
  function peg$f17(varName) {    return options.termFactory.create(varName);  }
  ...
  function peg$parseTerm() {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parsePrefixCompoundTerm();
        if (s0 === peg$FAILED) {
  ...
  function peg$parsePrefixCompoundTerm() {
    ...
    if (s1 !== peg$FAILED) {
      s2 = peg$parse_();
      s3 = peg$parseInfixOperatorOrLogic();
      if (s3 !== peg$FAILED) {
        s4 = peg$parse_();
  ...
  function peg$parseInfixOperatorOrLogic() {
    let s0, s1;
