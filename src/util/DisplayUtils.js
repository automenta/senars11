 ...
 */
export const createTable = (headers, rows, columnWidths = []) => {
 ...
 */
export const createProgressBar = (progress, width = 20, completeChar = '█', incompleteChar = '░') => {
 ...
 */
export const formatKeyValuePairs = (obj, prefix = '  ', includeEmpty = false) => {
    ...
    const formattedEntries = entries
        ...
        .map(([key, value]) => {
            ...
            const formattedValue = _formatValue(value);
 ...
 */
export const indent = (text, spaces = 2) => {
    if (!text) return '';
 ...
 */
export const formatListWithEmoji = (items, emoji = '•', prefix = '  ') => {
 ...
 */
export const printDataFrame = (df, options = {}) => {
    ...
    try {
        ...
        // Create the table
        let table = createTable(headers, dataRows);
