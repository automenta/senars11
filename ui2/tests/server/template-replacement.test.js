 ...
 * @description Tests for template replacement functionality in ui2 server.js
 */
...
describe('ui2 Template Replacement Tests', () => {
    const testPort = 8100;
...
<body>
    ...
    test('Server serves index.html with replaced templates', (done) => {
        ...
        serverProcess.stdout.on('data', (data) => {
            ...
            if (output.includes(`UI2 Server running at http://localhost:${testPort}`)) {
