...
import { calculatePriorityChange, getPriorityChangeColor, formatConceptDetails, sortConceptsByTime } from '../utils/conceptUtils.js';
...
const ConceptPanel = () => {
  ...
  const renderConcept = useCallback((concept, index) => {
    ...
    return React.createElement('div',
      ...
      React.createElement('div', 
        {
          style: { ...typography.subtitle, display: 'flex', justifyContent: 'space-between', cursor: 'pointer' },
      ...
      isExpanded && React.createElement('div', {style: {marginTop: '0.5rem', padding: '0.5rem', backgroundColor: '#f8f9fa', borderRadius: '4px'}},
  ...
  const renderTimelineView = useCallback(() => {
    ...
    return React.createElement('div', null,
      React.createElement('div', {style: {fontWeight: 'bold', fontSize: '1.1rem', marginBottom: '1rem', color: '#007bff'}}, 
        ...
        timelineData.map((item, index) => 
          React.createElement('div', 
            ...
            React.createElement('div', {style: {flex: 1}},
              ...
              React.createElement('span', {style: {marginLeft: '0.5rem', color: '#007bff'}}, item.priority.toFixed(3))
            ),
            React.createElement('div', {style: {flex: 1}},
