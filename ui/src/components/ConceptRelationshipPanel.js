            ...
            React.createElement('table', 
                ...
                React.createElement('thead', null,
                    React.createElement('tr', 
                        ...
                        React.createElement('th', {style: {padding: '0.5rem', border: '1px solid #dee2e6'}}, 'Strength'),
                ...
                React.createElement('tbody', null,
                    relationships.map((rel, index) => 
                        React.createElement('tr', 
                            ...
                            React.createElement('td', {style: {padding: '0.5rem', border: '1px solid #dee2e6'}}, rel.type),
                            React.createElement('td', 
                                {
                                    style: {padding: '0.5rem', border: '1px solid #dee2e6', cursor: 'pointer'},
                            ...
                            React.createElement('td', {style: {padding: '0.5rem', border: '1px solid #dee2e6'}}, rel.strength?.toFixed(2)),
                            React.createElement('td', {style: {padding: '0.5rem', border: '1px solid #dee2e6', maxWidth: '150px'}}, 
                                React.createElement('div', {style: {overflow: 'hidden', textOverflow: 'ellipsis'}}, rel.task)
                            )
                        )
                    )
                )
