                ...
                children: [
                    {
                        type: 'tabset',
                        weight: 50,
                        children: [{type: 'tab', component: 'ExplorerPanel', name: 'Explorer'}]
                    },
                    {
                        type: 'tabset',
                        weight: 50,
                        children: [{type: 'tab', component: 'VariablesPanel', name: 'Variables'}]
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        type: 'tabset',
                        weight: 60,
                        children: [{type: 'tab', component: 'DashboardPanel', name: 'Dashboard'}]
                    },
                    {
                        type: 'tabset',
                        weight: 40,
                        children: [{type: 'tab', component: 'SystemStatusPanel', name: 'Status'}]
                    }
                ]
            },
            {
