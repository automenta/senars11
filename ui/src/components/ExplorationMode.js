...
const reasoningExamples = [
  {
    ...
    steps: [
      ...
      { id: 2, description: 'Input: <{robin} --> {bird}>', explanation: 'This establishes that a robin is a type of bird' },
      { id: 3, description: 'Derivation: <{robin} --> {animal}>', explanation: 'NARS derives that a robin is an animal' },
      { id: 4, description: 'Priority: High', explanation: 'This inference has high confidence due to strong logical connection' }
    ]
  },
  {
    id: 'example-2',
    ...
    steps: [
      { id: 1, description: 'Input: Natural language query about ethics', explanation: 'User asks a complex ethical question' },
      { id: 2, description: 'LM processing: Context analysis', explanation: 'LM breaks down the ethical concepts' },
      { id: 3, description: 'NARS reasoning: Rule formation', explanation: 'NARS creates formal statements from the analysis' },
      { id: 4, description: 'Combined result: Ethical reasoning chain', explanation: 'Hybrid system produces comprehensive answer' }
    ]
  },
  {
    id: 'example-3',
    ...
    steps: [
      { id: 1, description: 'Input: Event A occurs before Event B', explanation: 'Temporal relationship established' },
      { id: 2, description: 'Input: Event B occurs before Event C', explanation: 'Additional temporal relationship' },
      { id: 3, description: 'Derivation: Event A occurs before Event C', explanation: 'NARS derives transitive relationship' },
      { id: 4, description: 'Confidence: Medium-High', explanation: 'Temporal reasoning typically has moderate confidence' }
    ]
  }
];
