...
const messageHandlers = {
    ...
    demoState: (data) => getStore().setDemoState(data.payload.demoId, data.payload),
    demoStep: (data) => getStore().addDemoStep(data.payload),
    demoMetrics: (data) => getStore().setDemoMetrics(data.payload.demoId, data.payload),
    demoList: (data) => getStore().setDemoList(data.payload.demos),
