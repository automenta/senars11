...
const createSelectors = (useStore) => {
    return Object.freeze({
        ...
        getWebSocketState: () => ({
            wsConnected: useStore.getState().wsConnected,
            wsService: useStore.getState().wsService
        }),
        ...
        getDemoState: () => ({
            demos: useStore.getState().demos,
            demoStates: useStore.getState().demoStates,
            demoSteps: useStore.getState().demoSteps
        }),
