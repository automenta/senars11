            ...
            {wsService && (
                <div style={exampleStyle} data-testid="narsese-examples">
                    ...
                    <ul style={{margin: '8px 0 0 20px', paddingLeft: '15px'}}>
                        ...
                        <li data-testid="example-implication">&lt;robin --&gt; bird&gt; &amp; &lt;bird
                            --&gt; animal&gt; =&gt; &lt;robin --&gt; animal&gt;. (Implication)
                        </li>
                    </ul>
                </div>
            )}
                ...
                <div style={{marginBottom: '20px'}} data-testid="notifications-section">
                    ...
                    <div style={{
                        ...
                        {notifications.slice(0, 10).map(notification => (
                            ...
                            >
                                <div><strong
                                    data-testid="notification-type">{notification.type?.toUpperCase()}:</strong> <span
                                    data-testid="notification-message">{notification.message}</span></div>
                ...
                <div data-testid="history-section">
                    ...
                    <div style={{
                        ...
                        {history.map(entry => (
                            ...
                            >
                                <div><strong>Input:</strong> <span data-testid="history-input">{entry.input}</span>
                                </div>
