...
describe('NAR Integration Tests', () => {
    ...
    describe('Memory Storage and Retrieval', () => {
        beforeEach(() => new TermFactory()); // Ensure factory is ready if needed
        ...
        test('should store tasks in appropriate concepts', async () => {
            ...
            ['cat', 'dog', 'animal'].forEach(term =>
                expect(allConceptTerms.some(t => t.includes(term))).toBe(true)
            );
        ...
        test('should handle compound terms correctly', async () => {
            ...
            expect(narProvider().getBeliefs().find(b =>
