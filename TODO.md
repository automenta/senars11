...
*   **Missing Logic**: The `inductive` demo (`BuiltinDemoSource.js`) claims to demonstrate induction, but the engine lacks the `InductionRule` to actually derive the conclusion. The demo is likely "aspirational" or broken.
