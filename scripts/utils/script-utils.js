...
export const ScriptUtils = {
     ...
     */
    parseArgs: (rawArgs, helpFlags = ['--help', '-h']) => {
        const args = [...rawArgs];
     ...
     */
    showUsageAndExit: (message, exitCode = 0) => {
        console.log(message);
